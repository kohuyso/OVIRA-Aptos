...
export const iconMap: Record<string, ImagePaths> = {
    ...
    APT: {
        lightMode: baseImgUrlToken('APT'),
        darkMode: baseImgUrlToken('APT'),
    },
    USDC: {
    ...
    Petra: {
        lightMode: baseImgUrlWallet('Petra'),
        darkMode: baseImgUrlWallet('Petra'),
    },
    WalletConnect: {
    ...
    Aptos: {
        lightMode: baseImgUrlSystem('Aptos'),
        darkMode: baseImgUrlSystem('Aptos'),
    },
};
